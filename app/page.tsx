...
import PinnedImages from "@/components/home/pinned-images";
    ...
    return (
        <main ref={containerRef}>
            ...
            >
                ...
                "
                        >
                            Pampprod<span className="text-[#ff3b3c]">.</span>
                        </Link>
                ...
                "
                        ...
                        <div className="mt-10 flex flex-col gap-8 lg:mt-12 lg:flex-row lg:items-end lg:justify-between">
                            <p className="max-w-md text-base leading-relaxed text-white/80 sm:text-lg">
                                Thoughtful photography for people, brands, and
                                the moments that matter. Captured with
                    ...
                    <div className="mx-auto container  w-full max-w-[1440px] px-5 sm:px-8 lg:px-12 ">
                        <header className="grid gap-8 lg:grid-cols-12 lg:items-end lg:gap-12">
                            ...
                            <div className="max-w-lg space-y-4 text-base leading-relaxed text-neutral-600 lg:col-span-5 lg:pb-1">
                                <p>
                                    Every shoot starts with a conversation. We
                                    take time to understand your story, your
                                    vision, and how you want the photographs to
                                    feel.
                                </p>

                                <p>
                                    From the first ideas to the final selection,
                                    we offer clear guidance and a relaxed
                                    experience—giving genuine moments room to
                                    unfold.
                                </p>
                            </div>
                        </header>
                            ...
                            <div className="grid gap-8 lg:grid-cols-12 lg:gap-12">
                                ...
                                <div className="lg:col-span-9">
                                    <p className="max-w-4xl text-3xl font-medium leading-[1.2] tracking-tight sm:text-4xl lg:text-5xl">
                                        A photograph should do more than show
                                        how a moment looked.
                                        <span className="text-neutral-500">
                                            {" "}
                                            It should bring you back to how it
                                            felt.
                                        </span>
                                    </p>
        ...
        "
                    ...
                    <div className="mx-auto max-w-[1440px] h-fit px-5 sm:px-8 lg:px-12">
                        ...
                        "
                            ...
                            <p className="max-w-md text-base leading-relaxed lg:col-span-4 lg:pb-2">
                                ...
                                edit that makes you feel something.
                            </p>
                        </header>
                        ...
                        <div className="mt-12 grid gap-8 border-t border-black/20 pt-8 sm:mt-16 lg:grid-cols-12 lg:items-center lg:gap-12">
                            <div className="lg:col-span-7">
                                ...
                                <p className="mt-3 max-w-lg text-sm leading-relaxed sm:text-base">
                                    Tell us what you have in mind. We’ll help
                                    shape the idea, plan the shoot, and bring it
                                    to the screen.
                                </p>
                            </div>
                    ...
                    <div className="mx-auto max-w-[1440px] px-5 sm:px-8 lg:px-12">
                        ...
                        "
                            ...
                            <div className="max-w-lg space-y-5 text-base leading-relaxed text-neutral-600 lg:col-span-5 lg:pt-2">
                                <p>
                                    Every story begins with listening. We take
                                    time to understand the people, places, and
                                    experiences behind what you see.
                                </p>

                                <p>
                                    Through thoughtful interviews and patient
                                    observation, we create documentaries that
                                    make room for complexity, preserve
                                    individual voices, and bring audiences
                                    closer.
                                </p>
                            </div>
                        </div>
                ...
                <div className="rotated w-full bg-[#182D27] py-16 font-sans text-white sm:py-24 lg:py-32">
                    ...
                    "
                            ...
                            <p className="max-w-md text-base leading-relaxed text-white/75 lg:col-span-4 lg:pb-2">
                                ...
                                relaxed atmosphere to outdoor podcast sessions.
                            </p>
                        </div>
                        ...
                        <div className="mt-16 flex flex-col gap-8 rounded-3xl bg-white/5 p-6 sm:p-10 lg:flex-row lg:items-center lg:justify-between">
                            <div>
                                ...
                                <p className="mt-3 max-w-lg text-sm leading-relaxed text-white/65">
                                    Tell us about your format, your guests, and
                ...
                <div className="rotated w-full bg-white py-16 font-sans text-[#ff3b3c] sm:py-24 lg:py-32">
                    ...
                    "
                            ...
                            <p className="mx-auto mt-8 max-w-xl text-base leading-relaxed sm:text-lg">
                                The quiet anticipation. The familiar faces. The
                                laughter you didn’t see coming. We capture the
                                moments that make your wedding yours.
                            </p>
                        </header>
                ...
                "
                        ...
                        <div className="mt-16 rounded-3xl bg-[#ff3b3c] px-6 py-10 text-center text-white sm:mt-24 sm:px-10 sm:py-14">
                            ...
                            <p className="mx-auto mt-4 max-w-md text-sm leading-relaxed sm:text-base">
                                Share your wedding date, location, and a little
                        ...
                        "
                                ...
                                <div className="mt-8 max-w-xl space-y-5 text-base leading-relaxed">
                                    <p>
                                        ...
                                        otherwise miss—a glance, a gesture, the
                                        way someone lights up when they feel at
                                        ease.
                                    </p>

                                    <p>
                                        My approach starts with getting to know
                                        you. I want you to feel comfortable
                                        being yourself, with enough guidance to
                                        feel confident and enough freedom for
                                        something natural to happen.
                                    </p>

                                    <p>
                                        Whether I’m photographing a person or
                                        telling a story on film, I want the
                                        result to feel personal. Something you
                    ...
                    "
                        ...
                        <div className="lg:col-span-4">
                            <p className="max-w-sm text-base leading-relaxed">
                                A film, a photograph, a conversation. Tell us
                                what you’re planning, and we’ll take it from
                                there.
                            </p>
                    ...
                    "
                        ...
                        <div className="max-w-xs">
                            ...
                            <p className="mt-4 text-sm leading-relaxed">
                                Photography and filmmaking for people, brands,
            ...
            "
                    ...
                    <div className="mt-4 flex flex-wrap items-center justify-between gap-4 border-t border-white/30 pt-6 text-xs leading-relaxed">
                        <p>
                            © {new Date().getFullYear()} Pampprod. All rights
                            reserved.
                        </p>
